...
const services = [
  {
    ...
    description:
      "Our deep learning models analyze your Solidity code for vulnerabilities, gas inefficiencies, and security flaws that traditional audits miss.",
    stats: { label: "Vulnerabilities Detected", value: "99.7%" },
    tag: "AI Security",
  },
  {
    icon: Shield,
    ...
    description:
      "Enterprise-grade security infrastructure protecting your assets with AI-enhanced threat detection and multi-signature wallet technology.",
    stats: { label: "Threats Blocked", value: "2.4M+" },
    tag: "Security",
  },
  {
    icon: Zap,
    ...
    description:
      "Transfer assets seamlessly across 50+ blockchain networks with AI-optimized routing for lowest fees and fastest finality.",
    stats: { label: "Networks Supported", value: "50+" },
    tag: "Infrastructure",
  },
  {
    icon: LineChart,
    ...
    description:
      "Machine learning models that predict gas prices, identify market trends, and provide intelligent protocol insights in real-time.",
    stats: { label: "Prediction Accuracy", value: "98.4%" },
    tag: "AI Analytics",
  },
  {
    icon: Code2,
    ...
    description:
      "Full-stack blockchain development services from ideation to mainnet deployment, with integrated AI-powered testing and optimization.",
    stats: { label: "Contracts Deployed", value: "12K+" },
    tag: "Development",
  },
  {
    icon: Server,
    title: "Node Infrastructure & RPC",
    description:
      "Scalable, AI-managed node infrastructure with 99.9% uptime SLA, automatic failover, and predictive scaling based on demand.",
    stats: { label: "Uptime SLA", value: "99.9%" },
    tag: "Infrastructure",
  },
];

const capabilities = [
  { icon: Cpu, label: "ML Models", value: "847" },
  { icon: Database, label: "Data Points", value: "1.2B+" },
  { icon: Lock, label: "Secured TVL", value: "$4.8B" },
  { icon: Activity, label: "Transactions", value: "89M+" },
  { icon: Layers, label: "Protocols", value: "340+" },
  { icon: GitBranch, label: "Integrations", value: "120+" },
];
...
export default function ServicesPage() {
  return (
    <div className="min-h-screen bg-neutral-950">
      ...
      {/* Hero Section */}
      <section className="relative pt-16 sm:pt-20 md:pt-28 pb-12 sm:pb-16 md:pb-24">
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div
            className="absolute top-0 left-1/2 -translate-x-1/2 w-[300px] sm:w-[400px] md:w-[600px] h-[200px] sm:h-[300px] md:h-[400px] rounded-full blur-3xl opacity-20"
            style={{
              background:
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center relative">
          ...
          <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight text-neutral-100 leading-[1.15] px-2">
            <span className="text-neutral-200">Enterprise-grade AI &</span>
              ...
              {capabilities.map((cap) => (
                <div key={cap.label} className="text-center">
                  <div className="inline-flex items-center justify-center h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 rounded-lg sm:rounded-xl bg-white/5 ring-1 ring-white/10 mb-1.5 sm:mb-2 md:mb-3">
                    <cap.icon className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6 text-brand" />
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-16">
            ...
            <p className="mt-3 sm:mt-4 max-w-3xl mx-auto text-sm sm:text-base md:text-lg text-neutral-400 leading-relaxed px-2">
              Our comprehensive suite of AI-enhanced blockchain services covers every aspect of Web3 development.
            </p>
          </div>
                ...
                <div className="relative p-5 sm:p-6 md:p-8">
                  <div className="flex items-start justify-between mb-4 sm:mb-5">
                    <div className="inline-flex items-center justify-center h-12 w-12 sm:h-14 sm:w-14 rounded-xl sm:rounded-2xl bg-white/5 ring-1 ring-white/10">
                      <service.icon className="h-6 w-6 sm:h-7 sm:w-7 text-brand" />
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 sm:mb-14">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold tracking-tight leading-[1.1]">
              ...
              <span className="block text-neutral-100">AI-powered solutions</span>
            </h2>
            <p className="mt-3 sm:mt-4 max-w-3xl mx-auto text-sm sm:text-base md:text-lg text-neutral-400 leading-relaxed px-2">
              Our streamlined process ensures rapid deployment without compromising on quality or security.
            </p>
          </div>
          ...
          <div className="relative mt-12 sm:mt-20">
            ...
            <div className="relative max-w-5xl mx-auto px-2 sm:px-6">
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-10">
                {[
                  { step: "Discovery", desc: "Analyze your requirements and define AI integration points" },
                  { step: "Architecture", desc: "Design scalable infrastructure with ML pipelines" },
                  { step: "Development", desc: "Build and test with AI-powered quality assurance" },
                  { step: "Deployment", desc: "Launch with continuous monitoring and optimization" },
                ].map((item, i) => (
