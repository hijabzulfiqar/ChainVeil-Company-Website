    ...
    <section className="relative">
      <div className="text-center max-w-4xl mx-auto pt-4 sm:pt-6 px-4 sm:px-6 space-y-6 sm:space-y-8">
        ...
        <h1 className="mt-2 sm:mt-3 text-3xl sm:text-5xl lg:text-6xl font-semibold tracking-tight">
          ...
          <span className="block bg-clip-text pb-1.5 text-transparent bg-gradient-to-br from-neutral-50 to-neutral-300">
      ...
      {/* Dashboard */}
      <div
        className="relative max-w-5xl mt-8 sm:mt-14 mx-auto px-4 sm:px-6"
        style={{ perspective: "1000px" }}
      >
        <div className="pointer-events-none relative mb-4 hidden sm:block">
          <div
            className="absolute -top-10 left-1/2 h-16 w-full max-w-4xl -translate-x-1/2 rounded-full blur-xl"
            style={{
              background:
                "linear-gradient(to right, transparent, rgba(129, 214, 88, 0.6), transparent)",
            }}
          />
          <div
            className="absolute -top-4 left-1/2 h-8 w-3/4 -translate-x-1/2 rounded-full blur-lg"
            style={{
              background:
                "linear-gradient(to right, transparent, rgba(129, 214, 88, 0.4), transparent)",
            }}
          />
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5">
              ...
              <aside className="hidden lg:block border-r border-white/10 p-3">
                <div className="flex items-center gap-2 px-2">
                  <span className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-neutral-800 ring-1 ring-white/10 overflow-hidden">
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(to bottom right, #81D658, #6BC248)",
                      }}
                    />
                  </span>
                  <div>
                ...
                <nav className="mt-4 space-y-0.5">
                  <a
                    className="flex items-center gap-2 rounded-md bg-white/5 px-2 py-1.5 text-xs text-white ring-1 ring-white/10"
                    href="#"
                  >
                  ...
                  <a
                    className="flex items-center gap-2 rounded-md px-2 py-1.5 text-xs text-neutral-300 hover:bg-white/5 hover:text-white transition"
                    href="#"
                  >
                ...
                <div className="p-3 sm:p-4">
                  <div className="mb-3 sm:mb-4">
                    <div className="flex items-center justify-between mb-2 sm:mb-3">
                      <h2 className="text-sm sm:text-base font-semibold tracking-tight">
                        AI & Blockchain Overview
                      </h2>
                      <span
                        className="inline-flex items-center gap-1 rounded-full px-1.5 sm:px-2 py-0.5 text-[10px] sm:text-xs font-medium ring-1"
                        style={{
                          backgroundColor: "rgba(129, 214, 88, 0.1)",
                          color: "#81D658",
                          borderColor: "rgba(129, 214, 88, 0.2)",
                        }}
                      >
                    ...
                    <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-3 sm:mb-4">
                      {[
                        ...
                        <div
                          key={metric.label}
                          className="rounded-lg border border-white/10 bg-neutral-900/60 p-2 sm:p-3"
                        >
                          ...
                          <div
                            ...
                            style={{
                              color: metric.positive ? "#81D658" : "#f87171",
                            }}
                          >
                            {metric.change}
                          </div>
                        ...
                        {[40, 60, 80, 45, 75, 90, 70].map((height, i) => (
                          <div
                            ...
                            style={{
                              ...
                              background:
                                i >= 5
                                  ? "linear-gradient(to top, #6BC248, #81D658)"
                                  : "linear-gradient(to top, #81D658, #9AE076)",
                            }}
                          />
                        ))}
                      </div>
                        ...
                        <div className="relative">
                          <div
                            ...
                            style={{
                              ...
                              border: "4px solid rgba(129, 214, 88, 0.3)",
                              borderTopColor: "#81D658",
                              borderRightColor: "#6BC248",
                              borderBottomColor: "#9AE076",
                            }}
                          />
                          <div className="absolute inset-0 flex items-center justify-center text-[10px] sm:text-xs font-semibold">
                            67%
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="hidden sm:block rounded-lg sm:rounded-xl border border-white/10 bg-neutral-900/60 overflow-hidden">
                    <div className="flex items-center justify-between px-3 sm:px-4 py-2 sm:py-3 border-b border-white/10">
                      ...
                      <a
                        href="#"
                        className="text-[10px] sm:text-xs text-neutral-300 hover:text-white"
                      >
                        View all
                      </a>
                    </div>
                      ...
                      <table className="w-full text-left">
                        <thead className="text-[10px] sm:text-xs text-neutral-400">
                          <tr className="border-b border-white/10">
                            <th className="px-3 sm:px-4 py-1.5 sm:py-2 font-medium">
                              Type
                            </th>
                            <th className="px-3 sm:px-4 py-1.5 sm:py-2 font-medium hidden md:table-cell">
                              Hash
                            </th>
                            <th className="px-3 sm:px-4 py-1.5 sm:py-2 font-medium">
                              Block
                        ...
                        <tbody className="divide-y divide-white/10 text-[10px] sm:text-xs">
                          {[
                            ...
                            <tr key={row.event} className="hover:bg-white/5">
                              ...
                              <td className="px-3 sm:px-4 py-1.5 sm:py-2 text-neutral-300 hidden md:table-cell">
                                {row.user}
                              </td>
                              <td className="px-3 sm:px-4 py-1.5 sm:py-2">
                                {row.count}
                              </td>
                              <td className="px-3 sm:px-4 py-1.5 sm:py-2 text-neutral-400">
                                {row.time}
                              </td>
                            </tr>
                          ))}
